	...
	print conf
        if(conf>50 and conf<90):
	        ...
	        p.ChangeDutyCycle(4)    #Enviamos uma pressao de 4.5% para rodar o servo para a esquerda
                time.sleep(1)
		p.ChangeDutyCycle(7.5) 
		#reponse=urllib.urlopen('http://192.168.0.50:8080/json.htm?type=command&param=switchlight&idx=5&switchcmd=Set%20Level&level=0') 
        else:
	    if (conf<0):
            	Id="Para Tras"
	    if (conf>150):
            ...
            print recebe
	    print Id
	    #reponse=urllib.urlopen('http://192.168.0.50:8080/json.htm?type=command&param=switchlight&idx=5&switchcmd=Set%20Level&level=33')
